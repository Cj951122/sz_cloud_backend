...
import com.lunz.fin.utils.StringUtil;
import com.lunz.fin.xss.SQLFilter;
...
public class Query<T> extends LinkedHashMap<String, Object> {
    ...
    public ServiceApiResult buildResult() {
        ...
        try {
            ...
            return ServiceApiResult.ok().put("data", pageUtil.getList()).put("count", pageUtil.getTotalCount());

        } catch (Exception ex) {

            return ServiceApiResult.error(ex.getMessage());
        }
    }
}
